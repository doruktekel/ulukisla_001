      ...
      >
        <div className="absolute  inset-0 bg-black/20 flex items-start justify-center">
          <div className="text-white max-w-6xl mx-auto p-10 text-justify">
            {decodedToken && (
              <h1 className="md:text-2xl text-md font-semibold content split uppercase bg-black/30 md:p-4 p-2">
            ...
            <p className="md:text-xl text-sm content2 bg-black/30 md:p-5 p-1 ">
